...
*/
    ...
    /* a failed attempt to follow the above instruction, hence commented out:
    ...
    var instance = fibonacciAdder()
    
    // To call the instance using a method
    func fibonacciNumberAtIndex (instance: Int) -> Int {
        
    }
    */
    
    @IBAction func fiboCalc(sender: AnyObject) {
        var input = inputNum.text.toInt()!
